...
const ROWS = Array.from({ length: 240 }, (_, index) => ({
  id: String(index + 1),
  label: `FlatList transport row ${index + 1}`,
}));

/**
 * First production-matrix probe.
 *
 * This intentionally mirrors transport-probe.tsx and changes only the React Native scroll source:
 * ScrollView -> FlatList. The native transport, TopAppBar and FloatingToolbar remain untouched.
 */
export default function TransportFlatListProbeScreen() {
  return (
